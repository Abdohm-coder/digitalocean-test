  ...
  return (
    <section className="py-5">
      ...
      <p>
        ...
        venues? We have your tickets for indie concerts here, too! Interested in international genres such as K-pop?
        Check out their upcoming tour schedules and see your favorite international band at a venue near you!
      `}
      </p>
      <p>
      ...
      <p>
        {`Not sure what you’re looking for? That’s okay, too. Check out these
        options below to see what’s hot in our concert section:`}
      </p>
      <p>
        {`Still not finding anything you like? Check out more concert options
        here.`}
      </p>
    </section>
  );
